...
eg: python inference_videostream3.py --source ./train_data/example_imgs/00000000_joker_2.jpg --driving ./train_data/example_imgs/mimo2.mp4 --output --log --pose-estimator-model ./pretrained_models/human_model_files/pose_estimate/multiHMR_672_B.pt
"""
